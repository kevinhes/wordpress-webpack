  ...
  <form action="" class="row mb-6">
    <div class="col-lg-3">
      <div class="position-relative">
        <input type="text" class="form-control search-color-input" placeholder="搜尋色號...">
        <button
          type="button"
          class="search-color-btn position-absolute end-0 top-50 translate-middle d-flex align-items-center">
    ...
    <div class="col-lg-2">
      <button type="button" class="search-color-reset d-block bg-gray3 py-3x3 px-8 white-space-none">重置</button>
    </div>
  </form>
  <!-- search form -->
