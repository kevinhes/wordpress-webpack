  ...
  <div class="row layout-bottom-l layout-sm-bottom-l">
    ...
    <div class="offset-lg-1 col-lg-6">
      ...
      <div class="row">
        <div class="col">
          <a
            class="addQaBtn btn btn-lg btn-secondary d-flex align-items-center justify-content-center"
            href="#"
        ...
        <div class="col">
          <a class="btn btn-lg btn-secondary d-flex align-items-center justify-content-center" href="<?php echo $product_main_content['color_link']['url'] ?>">
